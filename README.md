...
```
If you disable the CompleteMagic package you'll have to comment out the second keybinding above for snippets to behave normally in this context. In some cases it may be necesseray to force a re-read of the completions files with Ctrl-Alt-r.
